...
public class ClassDAO extends DAO {
	...
	public static final String COULDNT_CLOSE_CLASS = "Não foi possível fechar a turma.";
	public static final String CLASS_TABLE_NAME = "Class";
	public static final String ID_CLASS_COLUMN = "id_class";
	...
	public void update(Class enrolledClass, int newStatus) throws ClassException {
		...
		getNewStatusObject(newStatus).update(newStatus, classId, this);
	}
	/**
	...
	private NewStatus getNewStatusObject(int newStatus) {
		if (newStatus == CLOSED_CLASS)
			return new ClosedClass();
		return null;
	}
