...
public class Class  {
	 ...
	 */
	public String[] getLineOfStringByClass() {
		String[] classeString = new String[9];
		classeString[0] = getClassId();
		classeString[1] = getCourse().getName();
		classeString[2] = getTeacher().getName();
		classeString[3] = getShift();
		classeString[4] = getStartDate().getHyphenFormattedDate();
		classeString[5] = getEndDate().getHyphenFormattedDate();
