...
public class M012_CreatingClassTable extends Migration {
	...
	public void up() throws SQLException{
		...
		String classTableQuery = classTableQuery();
		setQuery(classTableQuery);
		run();
		
		String studentClassTableQuery = studentClassTableQuery();
		setQuery(studentClassTableQuery);
		run();
	}

	private String studentClassTableQuery() {
		...
		return studentClassTableQuery;
	}

	private String classTableQuery() {
