		...
		alterTeacherBtn.addMouseListener(new MouseAdapter() {
			...
			private void editTeacher() throws PersonException, TeacherException {
				...
				try {
					...
					Address address = new Address(addressInfo, addressNumber, addressComplement, addressCep,
							addressCity);
					...
					teacher = teacherController.updateTeacher(teacherName, teacherCpf, teacherRg, birthdate, email,
							address, principalPhone, secondaryPhone, motherName, fatherName, qualification);
