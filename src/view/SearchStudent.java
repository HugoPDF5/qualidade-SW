...
public class SearchStudent extends PersonView {
	...
	public void createLabelsAndFields(JFrame frame, Person person) {
		...
		ButtonColumn buttonColumn2 = buttonColumn2();
	...
	private ButtonColumn buttonColumn2() {
		...
		Action visualizeStudent = new AbstractAction() {
			public void actionPerformed(ActionEvent e) {
				...
				} catch (CPFException | StudentException | PhoneException | DateException | AddressException
						| RGException | CourseException | ServiceException | PaymentException e1) {
	...
	private void buildTableWithSearchedStudent(String searchedStudent) throws StudentException, CPFException, PersonException {
		...
		if(!resultOfTheSearch.isEmpty()){
			while(arrayIndex < resultOfTheSearch.size()){
				String[] student = student(resultOfTheSearch, arrayIndex);
	...
	private String[] student(ArrayList<Student> resultOfTheSearch, int arrayIndex) {
